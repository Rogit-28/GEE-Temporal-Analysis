...
@media print {
    ...
    <!-- Leaflet 1.9.4 JS (inlined for offline use) -->
    <script>
/* @preserve
...
<body>
    ...
    <div id="header">
        <h1>SatChange Analysis Results</h1>
        <p>Detecting temporal changes in satellite imagery</p>
    </div>
    
    <div id="controls">
        <div class="control-group">
            <button id="btn-before" onclick="showLayer('before')">Date A</button>
            <button id="btn-after" onclick="showLayer('after')">Date B</button>
    ...
    <div class="legend">
        ...
        <div class="legend-item">
            <div class="legend-color" style="background: rgba(0,100,255,0.7)"></div>
            <span>Water Expansion</span>
        </div>
        <div class="legend-item">
            <div class="legend-color" style="background: rgba(255,165,0,0.7)"></div>
            <span>Water Reduction</span>
        </div>
        <div class="legend-item">
            <div class="legend-color" style="background: rgba(128,128,128,0.7)"></div>
            <span>Urban Development</span>
        </div>
        <div class="legend-item">
            <div class="legend-color" style="background: rgba(64,64,64,0.7)"></div>
            <span>Urban Decline</span>
        </div>
    </div>
    ...
    <div id="stats">
        <div class="stats-container">
            ...
            <div class="stat-item">
                <div class="stat-value">{{ stats.water_reduction.percent }}%</div>
...
class GeoTIFFExporter:
    """Export classification results as GeoTIFF files."""
