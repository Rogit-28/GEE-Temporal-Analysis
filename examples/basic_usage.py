...
def demonstrate_change_detection():
    ...
    try:
        ...
        print(f"Vegetation change mask shape: {vegetation_changes['change_mask'].shape}")
...
def demonstrate_error_handling():
    ...
    try:
        ...
        detector = ChangeDetector(threshold=1.5)  # Invalid threshold
...
def main():
    ...
    print("Note: This uses mock data since GEE authentication requires real credentials.")
    print()
